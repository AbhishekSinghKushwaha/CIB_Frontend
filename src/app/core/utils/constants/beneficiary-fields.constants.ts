...
import { BenefiaryTypeFieldMetadataInterface, BeneficiaryModel, BeneficiaryTypeFieldInterface } from "../../domain/beneficiary.model";
...
export const BeneficiaryTypeFieldsDict: Map<string,BeneficiaryField[]> = new Map([
    [
