...
@Component({
  selector: 'app-add-company-directors',
  templateUrl: './add-company-directors.component.html',
  styleUrls: ['./add-company-directors.component.scss']
})
export class AddCompanyDirectorsComponent implements OnInit {
