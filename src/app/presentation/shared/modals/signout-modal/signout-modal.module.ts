...
import { SignoutModalService } from '../../../../core/services/modal-services/signout-modal/signout-modal.service';

@NgModule({
  declarations: [SignoutModalComponent],
  imports: [CommonModule, MatStyleModule],
  exports: [SignoutModalComponent],
  providers: [SignoutModalService],
})
